...
const sections = [
  {
    icon: BookMarked,
    title: "Memories",
    description: "Your saved encounters will appear here.",
    count: "—",
  },
  {
    icon: Map,
    title: "Memory Map",
    description: "A visual map of everywhere your paths have crossed.",
    count: "—",
  },
  {
    icon: Radio,
    title: "Waves",
    description: "Reconnection requests you've sent and received.",
    count: "—",
  },
  {
    icon: User,
    title: "Profile",
    description: "Your private Crossed profile.",
    count: "—",
  },
];
      ...
      <div className="max-w-6xl mx-auto container-padding">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {sections.map((section, i) => (
            <div
              key={i}
              className="p-5 rounded-2xl border border-border bg-card relative overflow-hidden"
            >
              {/* Blur overlay indicating coming soon */}
              ...
              <p className="text-2xl font-bold mb-1">{section.count}</p>
